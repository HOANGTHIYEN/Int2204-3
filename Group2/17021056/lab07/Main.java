...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        CircleObject hinhtron1 = new CircleObject(new XYlocation(200, 150), 70,Color.DARKOLIVEGREEN);
        CircleObject hinhtron2 = new CircleObject(new XYlocation(300, 100), 70,Color.ANTIQUEWHITE);
                                                
        //di chuyen vat the
        XYlocation toadomoi = new XYlocation(200, 100);
        hinhtron1.moving(toadomoi);

        //them doi tuong vao cac layer
        layer1.add(hinhtron1);
        layer1.add(hinhtron2);
