...
public class JPaneshape extends JPanel{
	 static JButton removeTriangle = new JButton("Remove Triangle");
	 Layer x = new Layer();
	 Diagram dia = new Diagram();
	 public void khoitao() {
		 Circle circle = new lab6.Circle(100, 100, 100, true, Color.BLACK);
		 Rectangle rectangle = new Rectangle(50, 70, 100,200, true, Color.GREEN);
		 Square square = new Square(80, 100, 300, true, Color.BLACK);
		 Triangle triangle = new Triangle(Color.black, true, 300, 200, 300, 300, 400, 300, 0, 0);
		 Hexagon hexagon = new Hexagon(550, 525, 475, 450,475, 525, 500, 543, 543, 500, 457, 457, Color.GREEN, true, 0, 0);
		 dia.addLayer(x); 
	     x.addShape(circle);
