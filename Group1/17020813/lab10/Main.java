...
public class Main {
    ...
    public void cau1(){
        try {
            Main lab10 = new Main();
            File path = findFileByName("C:\\Users\\CCNE\\Documents\\NetBeansProjects\\JavaApplication1\\src\\javaapplication1", "Utils.java");
            lab10.setListStaticFunction(lab10.getAllFunctions(path));
            System.out.println(lab10.findFunctionByName("findFileByName(String, String)"));
