...
public class Hexagon extends Shape {
	...
	@Override
	public void show() {
		System.out.println("Hexagon Vị trí các đỉnh x =" + Arrays.toString(hx) + ",các đỉnh y =" + Arrays.toString(hy) + ", color=" + color + ", filled="
				+ filled + ", mid=" + mid + ", getColor()=" + getColor() + ", isFilled()=" + isFilled() );
	}
